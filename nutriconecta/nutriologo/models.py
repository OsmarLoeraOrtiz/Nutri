...
class Nutriologo(models.Model):
    ...
    foto_perfil = models.ImageField(upload_to='nutriologos_foto_perfil/', blank=True) #mover al eliminar los antiguos usuarios blank=False, null=False
    ...
    curriculum = models.FileField(upload_to='curriculum_nutriologo/', blank=True, null=True)  #mover al eliminar los antiguos usuarios blank=False, null=False
    certificado = models.FileField(upload_to='certificados_nutriologos/', blank=True, null=True) #mover al eliminar los antiguos usuarios blank=False, null=False
    identificacion_oficial = models.FileField(upload_to='identificacion_nutriologos/', blank=True, null=True) #mover al eliminar los antiguos usuarios blank=False, null=False
...
# Modelo de consultorio de los nutriologos
class Consultorio(models.Model):
    nutriologo = models.OneToOneField('Nutriologo', verbose_name='nutriologo', on_delete=models.CASCADE)
