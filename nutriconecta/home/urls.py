...
from nutriologo.views import actualizar_nutriologo, actualizar_consultorio, obtener_citas_publico, obtener_solicitud_citas_enviadas_nutriologo
urlpatterns = [
    ...
    path('obtener_solicitud_citas_enviadas/<str:username>/', obtener_solicitud_citas_enviadas_nutriologo, name='obtener_solicitud_citas_enviadas'),
    ...
    path('eliminar_solicitud_cita/', eliminar_solicitud_cita_nutriologo, name='eliminar_solicitud_cita'),
